...
const FAQItem = ({ question, answer, isOpen, onToggle }: FAQItemProps) => (
  <div className="border-b-2 border-neutral-6 hover:border-primary-8 transition-all duration-300">
    <button
      onClick={onToggle}
      className="w-full p-4 flex items-center justify-between text-left hover:bg-neutral-3 transition-colors duration-300 group"
    >
      <span className="text-neutral-12 font-medium text-lg group-hover:text-primary-10 transition-colors duration-300">
        {question}
      </span>
      <div
      ...
      >
        <svg
          ...
          viewBox="0 0 16 16"
          fill="none"
          className="text-neutral-11 group-hover:text-primary-10 transition-colors duration-300"
        >
          <path
            d="M12 6L8 10L4 6"
            stroke="currentColor"
    ...
    >
      <div className="px-4 pb-6">
        <p className="text-neutral-11 leading-relaxed">{answer}</p>
      </div>
    </div>
  </div>
);
      ...
      <div className="max-w-[1280px] mx-auto py-16">
        <div className="text-center mb-6">
          <div className="flex items-center justify-center gap-2 mb-4">
            ...
            <h2 className="text-2xl font-bold text-neutral-12">FAQ</h2>
          </div>
        </div>
