...
export function LanguageToggle({ className = "" }: LanguageToggleProps) {
  ...
  return (
    <motion.button
      ...
      className={`relative w-12 flex items-center h-full rounded-lg border border-transparent md:border-neutral-6 bg-transparent md:bg-neutral-3 hover:bg-neutral-4 transition-all duration-200 ${className}`}
      whileTap={{ scale: 0.95 }}
