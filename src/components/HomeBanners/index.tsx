...
export function HomeBanners() {
  return (
    <div className="max-w-screen-2xl mx-auto grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-3 sm:gap-4 lg:gap-6">
      <div className="bg-neutral-3 rounded-xl p-4 sm:p-6 h-[220px] sm:h-[240px] lg:h-[350px] w-full border-2 border-transparent hover:border-primary-8 transition-all duration-300 ease-in-out">
      ...
      <div className="relative rounded-xl h-[220px] sm:h-[240px] lg:h-[350px] w-full overflow-hidden border-2 border-transparent hover:border-primary-8 transition-all duration-300 ease-in-out group">
        ...
        <div className="relative z-10 p-4 sm:p-6 h-full flex flex-col items-start justify-end">
          <h1 className="text-neutral-12 font-bold text-xl sm:text-2xl lg:text-3xl">
            Suba no Leaderboard. <br className="hidden sm:block" /> Conquiste os
            prêmios!
          </h1>
      ...
      <div className="relative rounded-xl h-[220px] sm:h-[240px] lg:h-[350px] w-full overflow-hidden border-2 border-transparent hover:border-primary-8 transition-all duration-300 ease-in-out group sm:col-span-2 xl:col-span-1">
