...
async function handleGetStats() {
  ...
  const totalRevenue = revenueData?.reduce((sum, purchase) => sum + purchase.amount_purchased, 0) || 0;
...
async function handleGetStock(params: any) {
  if (!isSupabaseConfigured || !supabase) {
    const mockData = [
      { id: 1, prize_id: 8, prize_name: 'Team Jersey', current_stock: 48, initial_stock: 50 },
      { id: 2, prize_id: 9, prize_name: 'Official Ball', current_stock: 37, initial_stock: 40 },
      { id: 3, prize_id: 10, prize_name: 'Soccer Cleats', current_stock: 28, initial_stock: 30 },
      { id: 4, prize_id: 11, prize_name: 'MacBook M3', current_stock: 9, initial_stock: 10 },
      { id: 5, prize_id: 12, prize_name: 'iPhone 16 Pro Max', current_stock: 18, initial_stock: 20 },
      { id: 6, prize_id: 13, prize_name: 'Golden Ticket', current_stock: 3, initial_stock: 5 }
    ];
