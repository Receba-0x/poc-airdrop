export const navigationTranslations = {
  en: {
    ...
    // Footer Description
    "footer.description": "Loot4Fun is a Web3 surprise box platform that combines digital and physical collectibles, with on-chain transparency and community focus.",
