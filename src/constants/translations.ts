export const translations = {
  en: {
    ...
    "terms.dataCollection.isp":
      "Your ISP (Internet Service Provider, such as Sapo, Clix or others);",
    "terms.dataCollection.browser":
      "The browser used to visit our website (such as Internet Explorer or Firefox);",
    "terms.dataCollection.time":
      "The time of your visit and the pages visited within our website",
    "terms.cookies.title": "DoubleClick DART Cookie",
    "terms.cookies.google":
      "Google, as a third-party provider, uses cookies to display ads on our website;",
    "terms.cookies.dart":
    ...
    "box.claimInstructions":
      "Click Claim in your transaction history to receive it",
    ...
    "shipping.proceedMessage":
      "To proceed with your claim, we need your shipping address details to deliver your order",
    ...
    "nft.approveOperatorExplanation":
      "Before claiming your physical prize, you need to approve our server as an operator for this NFT. This will allow us to burn the NFT when you claim your prize.",
    "shipping.delegateRequired": "Approval Required",
    "shipping.delegateRequiredMessage":
      "To claim your physical prize, we need your permission to burn (destroy) the NFT associated with this item.",

    // Teams
    "teams.selectJersey": "Select Jersey",
    "teams.jerseySelectionMessage":
  ...
  pt: {
    ...
    "terms.dataCollection.isp":
      "O seu ISP (Internet Service Provider, como o Sapo, Clix ou outro);",
    "terms.dataCollection.browser":
      "O navegador utilizado ao visitar o nosso website (como Internet Explorer ou Firefox);",
    "terms.dataCollection.time":
      "O tempo da sua visita e as páginas visitadas dentro do nosso website",
    ...
    "boxes.description":
      "Abra caixas misteriosas e descubra recompensas incríveis",
    ...
    "box.claimInstructions":
      "Clique em Reclamar no seu histórico de transações para recebê-lo",
    ...
    "shipping.proceedMessage":
      "Para prosseguir com sua solicitação, precisamos dos detalhes do seu endereço de entrega para enviar seu pedido",
    ...
    "shipping.existingAddressFound":
      "Encontramos seu endereço de entrega existente:",
    ...
    "shipping.nftBurned":
      "Sua NFT foi queimada com sucesso como parte do processo de reivindicação.",
    "shipping.mustAgreeToTerms":
    ...
    "shipping.delegateRequiredMessage":
      "Para reclamar seu prêmio físico, precisamos da sua permissão para queimar (destruir) o NFT associado a este item.",

    // Teams
    "teams.selectJersey": "Selecione a Camisa",
    "teams.jerseySelectionMessage":
      "Por favor, selecione qual camisa de time você gostaria de receber:",
    "teams.corinthians": "Corinthians",
    "teams.brasil": "Brasil",
    "teams.flamengo": "Flamengo",
    "teams.inter": "Inter",
